...
import project.environment.service.UserSecurityService;
...
public class SecurityConfig {
    ...
    @Bean
    SecurityFilterChain filterChain(HttpSecurity http, UserSecurityService userSecurityService) throws Exception {
    ...
    @Bean
        // Ioc(Inversion of Control)로 등록.
    PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder();
    }

    @Bean
        //AuthenticationManager :UserSecurityService,passWoedEncoder를 내부적으로 사용해 인증과 권한 부여를 처리함
